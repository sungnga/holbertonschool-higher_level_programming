...
* You must use the [Star wars API](https://swapi.co/) with the endpoint `http://swapi.co/api/films/:id`
* You must use the module `request`
```
...
* The first argument is the API URL of the [Star wars API](https://swapi.co/): `http://swapi.co/api/films/`
...
* You must use the [Star wars API](https://swapi.co/)
* You must use the module `request`
```
